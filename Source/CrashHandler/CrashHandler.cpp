...
void CrashHandlerInfo::printMaps()
{
    ...
    const char* line;
    while (true) {
        ssize_t byteRead = ::read(m_mapsfile, m_buf, BUF_SIZE);
        // check error.
        ...
        memcpy(const_cast<char*>(m_fileContent.data()) + fileContentOldSize, m_buf, byteRead);
    }
}
...
void CrashHandlerInfo::printCrashTime()
{
