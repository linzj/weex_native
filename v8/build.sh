...
make android_"$ARCH".$BUILD_TYPE -j9 backtrace=off ${EXTRA_OPTION} armfpu=neon armfloatabi=softfp snapshot=off i18nsupport=off armthumb=on android_ndk_root=${ANDROID_NDK_ROOT}
