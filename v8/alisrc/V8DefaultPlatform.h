...
#ifndef __V8DefaultPlatform_h__
#define __V8DefaultPlatform_h__
...
class V8DefaultPlatform : public v8::Platform {
 public:
  V8DefaultPlatform();
  virtual ~V8DefaultPlatform();
